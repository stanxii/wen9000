...
test("Create dynatree", function() {
    $("#eoctree").dynatree({
        children: [
            {key: "_1", title: "Lazy 100 ½Úµãflat,forc,upd.", isFolder: true, isLazy: true, mode: "add100_flat_u" },
...
test("Add nodes to folder using API witout expanding", function() {
    ...
    benchmark("1000 nodes flat", function() {
        var node = $("#eoctree").dynatree("getTree").getNodeByKey("_7");
        addNodes(node, 1000, 0, 0);
    });

    benchmark("1000 nodes deep", function() {
        var node = $("#eoctree").dynatree("getTree").getNodeByKey("_8");
...
test("Load 100 nodes (flat)", function() {
    var parent  = $("#eoctree").dynatree("getTree").getNodeByKey("_1");
...
test("Remove children", function() {
    var root = $("#eoctree").dynatree("getRoot");
