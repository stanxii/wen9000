...
public class ServiceAlarmProcessor {
	...
	public static void dowork(String pat,String message) throws IOException{
	...
	public static void doalarm(Map<String, String> alarm) throws IOException {
	...
	public static void doupgrade(Map<String, String> alarm) throws IOException {
		Jedis jedis=null;			
		try {
			jedis = redisUtil.getConnection();
		}catch(Exception e){
