(function($){
	...
	function fun_CheckedCbats(data){
		if(data != ""){
			...
			if(filename == ""){
				alert("Not have choosen the upgrade!!!");
				return;
			}
			...
			alert("Please choose the CBAT which need to upgrade!")
		}
	}
	...
	function fun_Updateinfo(data){
		...
		if(data != ""){
			if(proc == total){
				$("#up_proc")[0].textContent = "Successful!!!!";
		...
		$('#upcbat_table').dataTable( {	  			 		
    		...
    		"fnRowCallback": function( nRow, aData, iDisplayIndex ) {
	        	if(aData[5] == "0"){
	        		...
	        		$('td:eq(5)', nRow).html( 'System socket io error' );	
	        	}else if(aData[5] == "51"){
	        		$('td:eq(5)', nRow).html( 'Operation waiting timeout' );	
	        	}else if(aData[5] == "52"){
	        		$('td:eq(5)', nRow).html( 'System generic io error' );	
	        	}else if(aData[5] == "53"){
	        		$('td:eq(5)', nRow).html( 'Download image file error' );	
	        	}else if(aData[5] == "54"){
	        		$('td:eq(5)', nRow).html( 'Image digital signature tag error' );	
	        	}else if(aData[5] == "55"){
	        ...
	        "aaSorting": [[ 0, "asc" ]],
			"aoColumns": [	
			              { "sTitle": "Choice" , "sClass": "center"},
						  { "sTitle": "MAC" , "sClass": "center"},
						  { "sTitle": "IP" , "sClass": "center"},
						  { "sTitle": "Device type" , "sClass": "center"},
					      { "sTitle": "Software version" , "sClass": "center"},
					      { "sTitle": "Upgrade status" , "sClass": "center"}
						],
