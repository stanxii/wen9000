	...
	$(function() {
		...
		function fun_AllHistoryAlarms(data) {
			...
			$.each(data, function(key, itemv) {
				var item = [itemv.alarmlevel,itemv.salarmtime, itemv.alarmcode,itemv.cbatmac,itemv.runingtime,itemv.enalarminfo];
			...
			pTable = $('#historyAlarm').dataTable({
				...
				"aoColumns" : [
					...
					{"sTitle" : "MAC","sWidth":"15%"	},
					{"sTitle" : "Running time","sWidth":"15%"	},
